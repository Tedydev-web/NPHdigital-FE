...
const DigitalAgency = () => {
	...
	return (
		<div>
			<Head>
				<title>NPH Digital - Chuyên Gia Digital Marketing & Agency</title>
				<meta
					name="description"
					content="NPH Digital - Cung cấp các giải pháp Digital Marketing toàn diện: SEO, Social Media, Quảng cáo Google và xây dựng thương hiệu số. Chúng tôi giúp doanh nghiệp tăng trưởng bền vững."
				/>

				<meta
					name="keywords"
					content="Digital Marketing, Agency, SEO, Social Media, Quảng cáo Google, Xây dựng thương hiệu, NPH Digital"
				/>
				<meta
					name="author"
					content="NPH Digital"
				...
				<meta
					property="og:title"
					content="NPH Digital - Chuyên Gia Digital Marketing & Agency"
				/>
				<meta
					property="og:description"
					content="NPH Digital cung cấp các giải pháp Digital Marketing toàn diện và hiệu quả cho doanh nghiệp."
				/>
				<meta
					property="og:type"
					content="website"
				...
				<meta
					...
					content="Cung cấp các giải pháp Digital Marketing toàn diện cho doanh nghiệp."
				/>
				<meta
					name="twitter:image"
