	...
	return (
		<>
			<Head>
					...
					<meta
							name="description"
							content="NPH Digital - Dịch vụ tương tác số: Phát triển ứng dụng di động, Thiết kế website, UX/UI, Marketing số, CRM, ERP, AI, và thuê ngoài IT."
					/>
					<meta
							name="keywords"
							content="Tương tác số, Phát triển ứng dụng di động, Thiết kế website, UX/UI, Marketing số, CRM, ERP, AI, Thuê ngoài IT, NPH Digital"
					/>
					<meta
							name="author"
							content="NPH Digital"
