...
const DigitalMarketingTestimonial = () => {
	...
	return (
		<>
			<section
/*************  ✨ Codeium Command 🌟  *************/
				className="testimonial__area-3" style={{backgroundImage: "url('https://cdn.cuberto.com/cb/footer/1.mp4')"}}
				className="testimonial__area-3" style={Background: url('https://cdn.cuberto.com/cb/footer/1.mp4')}
				ref={testimonialArea}>
/******  5cd86900-a69b-4fe6-a2d1-9cc2ec43cbf7  *******/
