		...
		<>
			<section
				...
				<video
					...
					loop
					muted
					style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover', zIndex: 1000 }}>
					<source
						src="../../../public/assets/imgs/testimonial/3/ropes.mp4"
						media="(min-width:768px)"
					/>
					<source src="/assets/footer/ropes-sm.mp4?2" />
				</video>
