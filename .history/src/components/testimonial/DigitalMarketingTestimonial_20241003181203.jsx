	...
	return (
		<>
			<section
				...
				ref={testimonialArea}>
					<div class="cb-footer-bg-media"><video crossorigin="anonymous" autoplay="" playsinline="" loop="" muted="" style="display: none;"><source src="/assets/footer/ropes.mp4" media="(min-width:768px)"><source src="/assets/footer/ropes-sm.mp4?2"></video><canvas data-engine="three.js r167" width="1669" height="840" style="display: block; width: 1669px; height: 840px;"></canvas></div>
