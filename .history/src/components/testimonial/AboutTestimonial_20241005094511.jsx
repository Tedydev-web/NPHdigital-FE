		...
		<>
			...
			<style jsx>{`
				.custom-image {
					...
					box-shadow: 0 15px 30px rgba(0, 0, 0, 0.3); /* Đổ bóng mềm mại */
					filter: grayscale(20%) brightness(1.1) contrast(1.2); /* Hiệu ứng màu sắc */
				}

				/* Hiệu ứng khi hover vào ảnh */
				.custom-image:hover {
					transform: scale(1.05) rotate(1deg); /* Zoom nhẹ và xoay ảnh khi hover */
					filter: grayscale(0%) brightness(1.2) contrast(1.3); /* Màu sắc sáng hơn khi hover */
					box-shadow: 0 25px 50px rgba(0, 0, 0, 0.5); /* Đổ bóng rõ hơn khi hover */
				}
			`}</style>
		</>
	);
