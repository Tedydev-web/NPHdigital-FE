	...
	return (
		<>
			<section
				...
				ref={testimonialArea}>
					<div class="cb-footer-bg-media">
						<video crossorigin="anonymous" autoplay="" playsinline="" loop="" muted="" style="display: none;"><source src="/assets/footer/ropes.mp4" media="(min-width:768px)"><source src="/assets/footer/ropes-sm.mp4?2"></video>
