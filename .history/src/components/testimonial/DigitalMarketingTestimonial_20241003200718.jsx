	...
	return (
		<>
			<section
				...
				ref={testimonialArea}>
				{showVideoBackground && <VideoBackground videoSrc="https://cdn.cuberto.com/cb/footer/1.mp4" />}
