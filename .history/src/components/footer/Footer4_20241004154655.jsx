						...
						<div className="col-xxl-12">
							<div className="footer__top-6 pt-150 pb-140">
								<div className="footer__item-6">
									...
									/>
									<p>
										When do they work well, and when do they <br /> on us and finally, when do we actually need how can we avoid them.
									</p>
								...
								<div className="footer__item-6">
									...
									<ul className="footer__link-6">
										<li>
											<Link href="/gioi-thieu">About Company</Link>
										</li>
										<li>
									...
									<div className="col-xxl-8 col-xl-8 col-lg-8 col-md-7">
										<div className="footer__nav">
											<ul
												...
												<li>
													<Link href="/lien-he">contact</Link>
												</li>
												<li>
													<Link href="/career">Career</Link>
												</li>
