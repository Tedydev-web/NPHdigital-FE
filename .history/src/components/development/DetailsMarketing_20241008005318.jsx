						...
						<div className="col-xxl-7 col-xl-7 col-lg-7 col-md-7">
							<div className="advertisement__wrapper">
								<div className="advertisement__content">
									<p>Quảng cáo số là công cụ mạnh mẽ giúp doanh nghiệp tiếp cận đúng đối tượng khách hàng, nâng cao độ nhận diện thương hiệu và tăng trưởng doanh thu. Tại NPH Digital, chúng tôi cung cấp giải pháp toàn diện với mục tiêu gia tăng lợi nhuận bền vững cho đối tác.</p>
									<p>Quy trình của chúng tôi bao gồm việc phân tích thị trường, xác định chiến lược quảng cáo tối ưu và triển khai chiến dịch hiệu quả nhằm mang lại kết quả tốt nhất cho khách hàng.</p>
								</div>
								<ul>
