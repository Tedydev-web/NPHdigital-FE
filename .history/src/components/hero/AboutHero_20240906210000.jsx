							...
							<div className="hero__about-content">
								...
								<div className="hero__about-info">
									...
									<div className="hero__about-text title-anim">
										<p style={{ textAlign: 'justify' }}>{'Qua một chặng đường xây dựng và phát triển, Cydeva đã dần khẳng định được vị trí của mình trong ngành công nghệ thông tin. Đến với Cydeva, các bạn không chỉ yên tâm về sản phẩm, dịch vụ mà còn cảm nhận được sự nhiệt huyết đam mê công nghệ của đội ngũ nhân viên có trình độ, kinh nghiệm từ chúng tôi.'}</p>{' '}
									</div>
								</div>
							</div>
						</div>
