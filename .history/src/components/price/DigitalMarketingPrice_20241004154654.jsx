							...
							<div className="faq__list-3">
								<Accordion
									...
									<Accordion.Item
										...
										<Accordion.Header>Design should enrich our day</Accordion.Header>
										<Accordion.Body>
											<div>
									...
									<Accordion.Item
										eventKey="1"
										className="accordion-item">
										<Accordion.Header>Bring their individual experience and creative</Accordion.Header>
										<Accordion.Body>
											<div>
												<p>This is the second `${`item's`}` accordion body. It is hidden by default, until the collapse plugin adds the appropriate classes that we use to style each element. These classes.</p>
											</div>
										</Accordion.Body>
									</Accordion.Item>
									...
									<Accordion.Item
										eventKey="2"
										className="accordion-item">
										<Accordion.Header>Human centred design to challenges</Accordion.Header>
										<Accordion.Body>
											<div>
												<p>Our design services starts and ends with a best-in-class experience strategy that builds brands. Through a process of iteration and prototyping design interfaces that bring joy to people</p>
											</div>
									...
									<Accordion.Item
										eventKey="4"
										className="accordion-item">
										<Accordion.Header>Developing core web applications</Accordion.Header>
										<Accordion.Body>
											<div>
												<p>Our design services starts and ends with a best-in-class experience strategy that builds brands. Through a process of iteration and prototyping design interfaces that bring joy to people</p>
											</div>
