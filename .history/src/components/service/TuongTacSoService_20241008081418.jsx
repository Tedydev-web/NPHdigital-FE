					...
					<div className="row">
						...
						<div className="col-xxl-9 col-xl-9 col-lg-9 col-md-9">
							...
							<div className="service__detail-content">
								...
								<p>Hãy để chúng tôi cùng bạn phát triển chiến lược tương tác số, từ việc nghiên cứu thị trường, thiết kế UX/UI cho đến triển khai giải pháp, nhằm tối ưu hóa hiệu quả kinh doanh và gia tăng sự hiện diện của thương hiệu trong kỷ nguyên số.</p>
							</div>
						</div>
					</div>
				</div>
