					...
					<div className="row">
						...
						<div className="col-xxl-9 col-xl-9 col-lg-9 col-md-9">
							...
							<div className="service__detail-content">
								...
								<p>Hãy để chúng tôi đồng hành cùng bạn trong hành trình chuyển đổi số, biến những thách thức thành cơ hội phát triển, và thúc đẩy sự thành công của doanh nghiệp bạn.</p>
							</div>
						</div>
					</div>
				</div>
