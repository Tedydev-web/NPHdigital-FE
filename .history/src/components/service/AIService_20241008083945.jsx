					...
					<div className="row">
						...
						<div className="col-xxl-9 col-xl-9 col-lg-9 col-md-9">
							...
							<div className="service__detail-content">
								...
								<p>
									Dịch vụ lập trình AI và tự động hóa của chúng tôi bao gồm:
									<ul>
										<li>+ Phân tích và tư vấn giải pháp AI phù hợp cho doanh nghiệp.</li>
										<li>+ Phát triển các ứng dụng AI tùy chỉnh để tối ưu hóa quy trình.</li>
										<li>+ Tự động hóa quy trình làm việc với công nghệ tự động hóa quy trình (RPA).</li>
										<li>+ Tích hợp AI vào hệ thống hiện có để nâng cao hiệu suất.</li>
										<li>+ Đào tạo và hỗ trợ kỹ thuật để đảm bảo khách hàng sử dụng hiệu quả các giải pháp AI.</li>
									</ul>
								</p>
								<p>NPH Digital cam kết mang lại giá trị vượt trội và kết quả thực tế, giúp doanh nghiệp của bạn phát triển mạnh mẽ trong kỷ nguyên số hóa.</p>
							</div>
						</div>
					</div>
				</div>
