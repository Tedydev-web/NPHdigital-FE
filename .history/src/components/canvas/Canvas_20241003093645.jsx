...
const Canvas = ({ bladeMode = "", ofCanvasArea }) => {
    ...
    return ( <
        ...
        style = {
            subAccordion === 4.1 ? { display: "" } : { display: "none" }
        } >
        <
        li >
        <
        ...
        ul className = "sub_title_2"
        style = {
            subAccordion === 4.2 ? { display: "" } : { display: "none" }
        } >
        <
        li >
        <
        ...
        ul className = "sub_title_2"
        style = {
            subAccordion === 4.3 ? { display: "" } : { display: "none" }
        } >
        <
        li >
        <
        ...
        ul className = "sub_title_2"
        style = {
            subAccordion === 4.4 ? { display: "" } : { display: "none" }
        } >
        <
        li >
        <
        ...
        ul className = "sub_title_2"
        style = {
            subAccordion === 4.5 ? { display: "" } : { display: "none" }
        } >
        <
        li >
        <
