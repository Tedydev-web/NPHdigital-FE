...
const Canvas = ({ bladeMode = '', ofCanvasArea }) => {
    ...
    return ( <
        ...
        <
        Link href = { '/digital-marketing' } > HOME < /Link> <div className="accordian-btn"> {accordion === 1 ? <a onClick={() => openData(0)}> - </a >: < a onClick = {
            () => openData(1) } > + < /a>} </div > { ' ' } <
        /div>{' '} <
        ...
        <
        Link href = { '/service' } > SERVICE < /Link> <div className="accordian-btn"> {accordion === 3 ? <a onClick={() => openData(0)}> - </a >: < a onClick = {
            () => openData(3) } > + < /a>} </div > { ' ' } <
        /div>{' '} <
        ul className = "sub_title"
        ...
        div className = "header_title d-flex" >
        <
        Link href = { '#' } > PAGES < /Link> <div className="accordian-btn"> {accordion === 4 ? <a onClick={() => openData(0)}> - </a >: < a onClick = {
            () => openData(4) } > + < /a>} </div > { ' ' } <
        /div>{' '} <
        ul className = "sub_title"
        ...
        <
        Link href = { '/service' } > Service < /Link> <div className="sub-accordian-btn"> {subAccordion === 4.1 ? <a onClick={() => openSubData(4)}> - </a >: < a onClick = {
            () => openSubData(4.1) } > + < /a>} </div > { ' ' } <
        /div>{' '} <
        ul className = "sub_title_2"
        ...
        div className = "d-flex justify-content-between" >
        <
        Link href = { '/portfolio' } > Portfolio < /Link> <div className="sub-accordian-btn"> {subAccordion === 4.2 ? <a onClick={() => openSubData(4)}> - </a >: < a onClick = {
            () => openSubData(4.2) } > + < /a>} </div > { ' ' } <
        /div> <
        ul className = "sub_title_2"
        ...
        div className = "d-flex justify-content-between" >
        <
        Link href = { '/team' } > team < /Link> <div className="sub-accordian-btn"> {subAccordion === 4.3 ? <a onClick={() => openSubData(4)}> - </a >: < a onClick = {
            () => openSubData(4.3) } > + < /a>} </div > { ' ' } <
        /div> <
        ul className = "sub_title_2"
        ...
        div className = "d-flex justify-content-between" >
        <
        Link href = { '/blog' } > blog < /Link> <div className="sub-accordian-btn"> {subAccordion === 4.4 ? <a onClick={() => openSubData(4)}> - </a >: < a onClick = {
            () => openSubData(4.4) } > + < /a>} </div > { ' ' } <
        /div> <
        ul className = "sub_title_2"
        ...
        div className = "d-flex justify-content-between" >
        <
        Link href = { '#' } > Others < /Link> <div className="sub-accordian-btn"> {subAccordion === 4.5 ? <a onClick={() => openSubData(4)}> - </a >: < a onClick = {
            () => openSubData(4.5) } > + < /a>} </div > { ' ' } <
        /div> <
        ul className = "sub_title_2"
        ...
        div className = "header_title" >
        <
        Link href = { '/blog' } > BLOG < /Link> <div className="accordian-btn"> {accordion === 5 ? <a onClick={() => openData(0)}> - </a >: < a onClick = {
            () => openData(5) } > + < /a>} </div > { ' ' } <
        /div>{' '} <
        ul className = "sub_title"
