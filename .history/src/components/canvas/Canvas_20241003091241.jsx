...
const Canvas = ({ bladeMode = '', ofCanvasArea }) => {
            ...
            if (typeof window !== 'undefined') {
                setTimeout(() => {
                    ...
                    for (let i = 0; i < rootParent.length; i++) {
                        ...
                        for (let j = 0; j <
                            firstParent.length; j++) {
                            if (firstParent[j].className.includes('header_title')) {
                                let
                                    arr = firstParent[j].children[0].textContent.split('');
                                let spanData = '';
        ...
        return ( < >
            ...
            <
            Link href = { '/' } > TRANG CHỦ < /Link> <div className="accordian-btn"> {accordion === 1 ? <a onClick={()=>
            openData(0)
        } > - < /a>: < a onClick={ ()=> openData(1) } > + < /a >
    } < /div> { ' ' } < /div > { ' ' } <
...
li >
    ...
    <
    Link href = { '/service' } > SERVICE < /Link> <div className="accordian-btn"> {accordion === 3 ? <a
onClick = {
    () => openData(0) } > - < /a>: < a onClick={ ()=>
openData(3)
} > + < /a>} </div > { ' ' } < /div>{' '} <
ul className = "sub_title"
style = { accordion === 3 ? { display: '' } : { display: ' none' } } >
    ...
    div className = "header_title d-flex" >
    <
    Link href = { ' #' } > PAGES < /Link> <div className="accordian-btn"> {accordion === 4 ? <a onClick={()=>
openData(0)
} > -
<
/a>: < a
...
className = "sub-accordian-btn" > {
        ...
        <
        Link href = { '/portfolio' } > Portfolio < /Link> <div className="sub-accordian-btn"> {subAccordion === 4.2 ? <a onClick={()=> openSubData(4)}> - </a > :
            <
            a
        onClick = {
            () =>
        ...
        Link href = { '/blog' } > blog < /Link> <div className="sub-accordian-btn"> {subAccordion === 4.4 ? <a onClick={()=> openSubData(4)}> - </a >: < a onClick = {
            () => openSubData(4.4) } > + < /a>} </div > { ' ' } < /div> < ul className="sub_title_2"
        style = {
            subAccordion === 4.4 ?
            {
                display: ''
        ...
        Link href = { ' #' } > Others < /Link> <div className="sub-accordian-btn"> {subAccordion === 4.5 ? <a onClick={()=> openSubData(4)}> - </a >: < a onClick = {
            () => openSubData(4.5) } > + < /a>} </div > { ' ' } < /div> < ul className="sub_title_2" style={
        subAccordion === 4.5 ?
        {
            display: ''
        } :
