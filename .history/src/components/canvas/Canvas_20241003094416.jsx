								...
								<ul
									...
									<li>
										<div className="header_title">
											<Link href={'/digital-marketing'}> TRANG CHỦ </Link> <div className="accordian-btn"> {accordion === 1 ? <a onClick={() => openData(0)}> - </a> : <a onClick={() => openData(1)}> + </a>} </div>{' '}
										</div>{' '}
										<ul
											className="sub_title"
											style={accordion === 1 ? { display: '' } : { display: 'none' }}>
											<li>
												<Link href={'/digital-marketing'}>Digital Maketing </Link>{' '}
											</li>{' '}
											<li>
												<Link href={'/digital-marketing-dark'}>Digital Maketing dark </Link>{' '}
											</li>{' '}
											<li>
												<Link href={'/design-studio'}> Design Studio </Link>{' '}
											</li>{' '}
											<li>
												<Link href={'/design-studio-dark'}>Design Studio dark </Link>{' '}
											</li>{' '}
											<li>
												<Link href={'/digital-agency'}> Digital Agency </Link>{' '}
											</li>{' '}
											<li>
												<Link href={'/digital-agency-dark'}>Digital Agency dark </Link>{' '}
											</li>{' '}
											<li>
												<Link href={'/creative-agency'}> creative Agency </Link>{' '}
											</li>{' '}
											<li>
												<Link href={'/creative-agency'}>creative Agency dark </Link>{' '}
											</li>{' '}
											<li>
												<Link href={'/startup-agency'}> Startup Agency </Link>{' '}
											</li>{' '}
											<li>
												<Link href={'/startup-agency-dark'}>Startup Agency dark </Link>{' '}
											</li>{' '}
											<li>
												<Link href={'/modern-agency'}> modern agency </Link>{' '}
											</li>{' '}
											<li>
												<Link href={'/modern-agency-dark'}>modern agency dark </Link>{' '}
											</li>{' '}
											<li>
												<Link href={'/personal-portfolio'}>personal Portfolio </Link>{' '}
											</li>{' '}
											<li>
												<Link href={'/personal-portfolio-dark'}>personal Portfolio dark </Link>{' '}
											</li>{' '}
										</ul>{' '}
									</li>{' '}
									<li>
									...
									<li>
										<div className="header_title d-flex">
											<Link href={'/service'}> SERVICE </Link> <div className="accordian-btn"> {accordion === 3 ? <a onClick={() => openData(0)}> - </a> : <a onClick={() => openData(3)}> + </a>} </div>{' '}
										</div>{' '}
										<ul
											className="sub_title"
											...
											<li>
												<Link href={'/service-details-dark'}>service details dark </Link>{' '}
											</li>{' '}
										</ul>{' '}
									</li>{' '}
									<li>
										<div className="header_title d-flex">
											<Link href={'#'}> PAGES </Link> <div className="accordian-btn"> {accordion === 4 ? <a onClick={() => openData(0)}> - </a> : <a onClick={() => openData(4)}> + </a>} </div>{' '}
										</div>{' '}
										<ul
											className="sub_title"
											style={accordion === 4 ? { display: '' } : { display: 'none' }}>
											<li className="sub_header_title">
												<div className="d-flex justify-content-between">
													<Link href={'/service'}> Service </Link> <div className="sub-accordian-btn"> {subAccordion === 4.1 ? <a onClick={() => openSubData(4)}> - </a> : <a onClick={() => openSubData(4.1)}> + </a>} </div>{' '}
												</div>{' '}
												<ul
													className="sub_title_2"
													style={subAccordion === 4.1 ? { display: '' } : { display: 'none' }}>
													<li>
														<Link href={'/service'}> service </Link>{' '}
													</li>{' '}
													<li>
											...
											<li className="sub_header_title">
												<div className="d-flex justify-content-between">
													<Link href={'/portfolio'}> Portfolio </Link> <div className="sub-accordian-btn"> {subAccordion === 4.2 ? <a onClick={() => openSubData(4)}> - </a> : <a onClick={() => openSubData(4.2)}> + </a>} </div>{' '}
												</div>
												<ul
													className="sub_title_2"
													style={subAccordion === 4.2 ? { display: '' } : { display: 'none' }}>
													<li>
													...
													<li>
														<Link href={'/portfolio-details-dark'}>portfolio details dark </Link>{' '}
													</li>{' '}
												</ul>{' '}
											</li>{' '}
											<li className="sub_header_title">
												<div className="d-flex justify-content-between">
													<Link href={'/team'}> team </Link> <div className="sub-accordian-btn"> {subAccordion === 4.3 ? <a onClick={() => openSubData(4)}> - </a> : <a onClick={() => openSubData(4.3)}> + </a>} </div>{' '}
												</div>
												<ul
													className="sub_title_2"
													style={subAccordion === 4.3 ? { display: '' } : { display: 'none' }}>
													<li>
													...
													<li>
														<Link href={'/team-details-dark'}>Team Details dark </Link>{' '}
													</li>{' '}
													<li>
														<Link href={'/career'}> career </Link>{' '}
													</li>{' '}
													...
													<li>
														<Link href={'/job-details-dark'}>job details dark </Link>{' '}
													</li>{' '}
												</ul>{' '}
											</li>{' '}
											<li className="sub_header_title">
												<div className="d-flex justify-content-between">
													<Link href={'/blog'}> blog </Link> <div className="sub-accordian-btn"> {subAccordion === 4.4 ? <a onClick={() => openSubData(4)}> - </a> : <a onClick={() => openSubData(4.4)}> + </a>} </div>{' '}
												</div>
												<ul
													className="sub_title_2"
													style={subAccordion === 4.4 ? { display: '' } : { display: 'none' }}>
													<li>
														<Link href={'/blog'}> blog </Link>{' '}
													</li>{' '}
													<li>
													...
													<li>
														<Link href={'/blog-details'}>blog details dark </Link>{' '}
													</li>{' '}
												</ul>{' '}
											</li>{' '}
											<li className="sub_header_title">
												<div className="d-flex justify-content-between">
													<Link href={'#'}> Others </Link> <div className="sub-accordian-btn"> {subAccordion === 4.5 ? <a onClick={() => openSubData(4)}> - </a> : <a onClick={() => openSubData(4.5)}> + </a>} </div>{' '}
												</div>
												<ul
													className="sub_title_2"
													style={subAccordion === 4.5 ? { display: '' } : { display: 'none' }}>
													<li>
														<Link href={'/about'}> about </Link>{' '}
													</li>{' '}
													<li>
									...
									<li>
										<div className="header_title">
											<Link href={'/blog'}> BLOG </Link> <div className="accordian-btn"> {accordion === 5 ? <a onClick={() => openData(0)}> - </a> : <a onClick={() => openData(5)}> + </a>} </div>{' '}
										</div>{' '}
										<ul
											className="sub_title"
											style={accordion === 5 ? { display: '' } : { display: 'none' }}>
											<li>
												<Link href={'/blog'}> blog </Link>{' '}
											</li>{' '}
											<li>
											...
											<li>
												<Link href={'/blog-details-dark'}>blog details dark </Link>{' '}
											</li>{' '}
										</ul>{' '}
									</li>{' '}
									<li>
					...
					<div className="offcanvas__right">
						...
						<div className="offcanvas__contact">
							...
							<ul>
								...
								<li> 230 Norman Street New York, QC(USA) H8R 1 A1 </li>{' '}
							</ul>{' '}
						</div>{' '}
						<Image
							priority
